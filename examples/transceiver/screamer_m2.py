...
class Platform(Xilinx7SeriesPlatform):
    ...
    resources   = [
        ...
        *LEDResources(pins="V17 U17", attrs=Attrs(IOSTANDARD="LVCMOS33")),
        ...
        Resource("pcie_tx", 0, DiffPairs("H2", "H1", dir="o")),
        Resource("pcie_rx", 0, DiffPairs("E4", "E3", dir="i")),
    ]
    connectors  = []
...
class GTPTestTop(Elaboratable):
    def elaborate(self, platform):
        ...
        m.submodules += _CRG(clk100.i, Signal())
...
def main():
    platform = Platform()
    platform.build(GTPTestTop(), name="screamer_m2")
